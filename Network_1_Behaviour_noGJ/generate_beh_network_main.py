...
def create_GoC_network( duration=1000, dt=0.025, seed=100, runid=0, mf=0.2, pf=0.2, hom=True, gje=False, run=False):
	...
	simid = 'behNet_'+format(runid,'05d')+'_mf_'+format(int(mf*100),'03d')+'_pf_'+format(int(pf*100),'03d')+'_'+hom_str + '_' + gj_str
