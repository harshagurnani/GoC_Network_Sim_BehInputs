...
def get_simulation_params(simid,
						  ...
						  clusInputs   = ["LocoMF", "LocoPF", "WMIAmpMF", "WMIAmpPF", "PupilMF", "PupilPF", "WSPMF", "WSPPF" ],
						  clusType     = {"LocoMF": "BehMF", "LocoPF":"BehPF", "WMIAmpMF": "BehMF", "WMIAmpPF":"BehPF", "PupilMF": "BehMF", "PupilPF":"BehPF", "WSPMF": "BehMF", "WSPPF":"BehPF"},
						  input_nFiles= { "MF_Step": 300, "MF_bg": 60, "PF_Step" : 300, "PF_bg" : 60, "MFON" : 200, "PFON" : 200, "MFOFF" : 200, "PFOFF" : 200, "MFRand" : 200, "PFRand" : 300, "BehMF": 100, "BehPF":100 },
						  nInputs_max = { "MF_Step": 60, "MF_bg": 60, "PF_Step" : 300, "PF_bg" : 300, "MFON" : 60, "PFON" : 300, "MFOFF" : 60, "PFOFF" : 300, "MFRand" : 60, "PFRand" : 300, "BehMF":15, "BehPF":30 },
						  nInputs_frac = { "MF_Step": .55, "MF_bg": .10, "PF_Step" : .45, "PF_bg" : .35, "MFON" : .5, "PFON": .5, "MFOFF" : .5, "PFOFF": .5, "MFRand" : .5, "PFRand": .5, "BehMF":.5, "BehPF":.5 },
						  Input_density = { "MF_Step": 0, "MF_bg": 0, "PF_Step" : 0, "PF_bg" : 0, "MFON": 0, "PFON" : 0, "MFOFF": 0, "PFOFF" : 0, "MFRand": 0, "PFRand" : 0 , "BehMF": 0, "BehPF": 0},
						  Input_dend = { "MF_Step": 3, "MF_bg": 3, "PF_Step" : 3, "PF_bg" : 3, "MFON" : 3, "PFON" : 3, "MFOFF" : 3, "PFOFF" : 3, "MFRand" : 3, "PFRand" : 3 , "BehMF": 3, "BehPF":3},
						  Input_nRosette = { "MF_Step": 0, "MF_bg": 0, "PF_Step" : 0, "PF_bg" : 0 , "MFON" : 0, "PFON" : 0,  "MFOFF" : 0, "PFOFF" : 0, "MFRand" : 0, "PFRand" : 0 , "BehMF":3, "BehPF":3 },
						  ...
						  connect_goc = { "MF_Step": False, "MF_bg": False, "PF_Step" : False,"PF_bg" : False, "MFON" : False,"PFON" : False, "MFOFF" : False,"PFOFF" : False, "MFRand" : False,"PFRand" : False, "BehMF": False, "BehPF":False},
						  clusVolume = {"LocoMF":[500,125,100], 
										"LocoPF":[500,125,100], 
						  ...
						  clusSpatialOffset = {"LocoMF":[0,0,0], 
											   "LocoPF":[0,0,0], 
											   "WMIAmpMF":[0,130,0], 
											   "WMIAmpPF":[0,130,0], 
											   "PupilMF":[0,260,0], 
	...
	for input in clusInputs:
		...
		Inp = { "type" : spktype, "syn_type": Input_syn[spktype] , "syn_loc": Input_cellloc[spktype], "id":idctr }
		Input_id[input] = idctr
		Inp["nInp"] = int(nInputs_max[spktype]*nInputs_frac[spktype])
		
		# restrict inputs to subvolume
		Inp["nInp"], Inp["pos"] = nu.locate_GoC( nGoC=Inp["nInp"], volume=clusVolume[input], seed=simid*ctr+Input_id[input] )
		...
		if Inp["nInp"]>0:
			...
			Inp["conn_pairs"], Inp["conn_wt"], Inp["conn_loc"] = nu.connect_inputs_known( nInp=Inp["nInp"], Inp_pos= Inp["pos"], mult=Input_nRosette[spktype], connType=Input_conn[spktype], connProb=Input_prob[spktype], connGoC=Input_nGoC[spktype], connWeight=Input_wt[spktype], connDist=Input_maxD[spktype], GoC_pos=params["GoC_pos"], cell_loc=Input_cellloc[spktype], nDend = Input_dend[spktype], seed=currseed)
			for pid in usedID:
				pairid = [x for x in range(Inp["conn_pairs"].shape[1]) if params["GoC_ParamID"][Inp["conn_pairs"][1,x]]==pid ]
				tmp["conn_pairs"].append( Inp["conn_pairs"][:,pairid] )
				tmp["conn_wt"].append( Inp["conn_wt"][pairid] )
