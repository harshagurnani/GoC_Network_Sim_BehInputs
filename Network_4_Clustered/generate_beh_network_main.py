...
def create_GoC_network( duration=1000, dt=0.025, seed=100, runid=0, mf=0.2, pf=0.2, order=[0,1,2,3], gje=True, run=False):
	'''
	...
	simid = 'behClusNet_'+format(runid,'05d')+'_mf_'+format(int(mf*100),'03d')+'_pf_'+format(int(pf*100),'03d')+'_order_{}{}{}{}'.format(order[0],order[1],order[2],order[3])+'_'+gje_str

	net = nml.Network( id=simid, type="networkWithTemperature" , temperature="23 degC" )
	net_doc = nml.NeuroMLDocument( id=net.id )
	net_doc.networks.append( net )

	arr_flnm = ['../Mechanisms/SpikeArray_MFON_dur_060_080.nml', '../Mechanisms/SpikeArray_Loco_dur_040.nml', '../Mechanisms/SpikeArray_Loco_PF_dur_040.nml', '../Mechanisms/SpikeArray_WMIAmp_dur_040.nml', '../Mechanisms/SpikeArray_WMIAmp_PF_dur_040.nml', '../Mechanisms/SpikeArray_Pupil_dur_040.nml', '../Mechanisms/SpikeArray_Pupil_PF_dur_040.nml', '../Mechanisms/SpikeArray_WSP_dur_040.nml', '../Mechanisms/SpikeArray_WSP_PF_dur_040.nml']
...
def get_params( runid=0, mf=0.2, pf=0.2, order=[0,1,2,3] ):
	...
	offset = order*125
	clusSpatialOffset = {"LocoMF":[0,offset[0],0], 
						 "LocoPF":[0,offset[0],0],
	...
	params = inp.get_simulation_params( runid, nInputs_max=nInputs_max, nInputs_frac=nInputs_frac, nGoC_pop = nPop, Input_prob=Input_prob, stepInputs=[], behInputs=[], clusSpatialOffset=clusSpatialOffset )
	return params
