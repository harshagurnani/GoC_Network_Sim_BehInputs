...
def create_GoC_network( duration=1000, dt=0.025, seed=100, runid=0, mf=0.2, pf=0.2, mf2=0.2, pf2=0.2, hom=True, run=False):
	...
	simid = 'biNet_'+format(runid,'05d')+'_mf_'+format(int(mf*100),'03d')+'_pf_'+format(int(pf*100),'03d')+'_mf2_'+format(int(mf2*100),'03d')+'_pf2_'+format(int(pf2*100),'03d')+'_'+hom_str
...
def get_params( runid=0, mf=0.2, pf=0.2, mf2=0.1, pf2=0.1, hom=False ):
	...
	nInputs_frac = { "MF_bg": 0.5, "PF_bg" : 0.5, 'MFON': mf, 'PFON' : pf, 'MFOFF': mf2, 'PFOFF' : pf2}
